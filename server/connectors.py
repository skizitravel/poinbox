...
class GmailConnector(InboxConnector):
    def fetch_recent(self) -> list[IncomingEmail]:
        raise NotImplementedError("Gmail connector is intentionally stubbed for the MVP.")


class OutlookConnector(InboxConnector):
    def fetch_recent(self) -> list[IncomingEmail]:
        raise NotImplementedError("Outlook connector is intentionally stubbed for the MVP.")
